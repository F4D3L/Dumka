    ...
    <nav class="nav_body">
        <div class="div_body">
            ...
            <div class="button_main">
                <button class="button_historias"><a href="../criar_textos/index.php">Criar textos</a></button>
                <button class="button_quizzes"><a href="../criar_quizzes/index.php">Criar quizzes</a></button>
            </div>
        </div>
    </nav>
