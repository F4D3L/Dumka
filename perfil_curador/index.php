...
<nav class="nav_body">
    <div class="div_body">
        <h1 class="h1_titulo">Usuário</h1>
        <h2 class="txt">
            <p>João Cordeiro</p>
        </h2>

        <h1 class="h1_titulo">E-mail</h1>
        <h2 class="txt">
            <p>joaocordeiro@gmail.com</p>
        </h2>

        <h1 class="h1_titulo">Categoria de Login</h1>
        <h2 class="txt">
            <p>Curador</p>
        </h2>

        <div class="button_main">
            <button class="button_registro2"><a href="../avaliar_textos/index.php">Avaliar textos</a></button>
        </div>
    </div>
</nav>
